...
const ProfileScreen = () => {
  ...
  const handleOtpVerify = async () => {
    const response = await axios.post(
      `${process.env.AUTH_URL}/verify-otp`,
      {
        email: user.email,
        otp: otp.join("")
      },
  ...
  const handlePasswordReset = async () => {
    const response = await axios.post(
      `${process.env.AUTH_URL}/reset-password`,
      {
        email: user.email,
        otp: otp.join(""),
        password: password,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          ...
          >
            <View>
              ...
              <Text
                style={{ fontSize: 14, fontWeight: "400", color: "#D7BC70" }}
              >
                (817) 237-7205
              </Text>
              <BlackThemeButton
            ...
            <View>
              ...
              <Text
                style={{ fontSize: 13, fontWeight: "400", color: "#D7BC70" }}
              >
                {user?.email}
              </Text>
              <GoldenButton
        ...
        <View style={styles.locationContainer}>
          ...
          <View>
            ...
            <Text style={{ fontSize: 13, fontWeight: "400", color: "#D7BC70" }}>
